...
/*
    Fonction permettant d'afficher une nouvelle fenetre en fonction de la largeur et la hauteur definie en parametre.
*/
int window_init(t_game_params *game)
{
    ...
    if (game->mlx_ptr == NULL)
        return (1);
    game->win_ptr = mlx_new_window(game->mlx_ptr, game->win_l, game->win_h, "SO_LONG");
