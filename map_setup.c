...
/*   Updated: 2023/03/08 13:56:03 by malleman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* 
    Fonction permettant de connaitre le nombre de ligne de ma map.ber
	qui definira la hauteur de ma map. 
    Elle ouvre le fd et check les erreur. 
    Elle va lire chaque lignes du fichier jusqu'a la fin et incrementer la
	variable nb_line a chaque tour de boucle. 
    Elle renvoie ensuite la variable nb_line une fois que le fichier entier
	a ete lu. 
*/
...
/*
    Fonction permettant de setup la memoire dynamique de ma map 2D en gerant
	les char. 
	Elle lit et stock la premiere ligne du fichier dans notre variable lignes.
    Elle boucle tant qu'elle trouve une ligne pour lire tout le fichier et va
	allouer la memoire pour chaque ligne.
    Elle copie a chaque boucle le caractere de line dans la case 
	correspondante de la matrice map.
*/
...
/*
    Fonction qui permet de stocker les donnees + allouer la memoire trouver 
	via get_nb_line et memset_range_line dans mes variables lines et map. 
    Elle stock egalement le nom du fichier dans map_fd. 
    Elle va allouer la memoire pour un tableau de chaine de caractere avec 
	ft_calloc et le stocker dans map.map. 
...
/*
    Fonction permettant d'initaliser les variables de ma structure
	"map_params" et "game_params".
*/
